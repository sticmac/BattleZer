...
module.exports = class SliderCardZone extends CardZone {
    ...
    initCards(hitCardsModels, styleCardsModels) {
        for (let i = 0; i < hitCardsModels.length; i++) {
            this.hitCards.push(new Card(hitCardsModels[i], 180, 0, this.cardWidth, this.cardHeight, this.scene, 'card_back'));
            this.styleCards.push(new Card(styleCardsModels[i], 620, 0, this.cardWidth, this.cardHeight, this.scene, 'card_back'));
        }
    }
